run_app:
	...
	find pages_files -exec sed -i.bak 's|_dash-component-suites|portfolio\\/_dash-component-suites|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-layout|portfolio/_dash-layout.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-dependencies|portfolio/_dash-dependencies.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_reload-hash|portfolio/_reload-hash|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-update-component|portfolio/_dash-update-component|g' {} \;
	find pages_files -exec sed -i.bak 's|assets|portfolio/assets|g' {} \;
